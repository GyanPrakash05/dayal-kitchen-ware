      ...
      <div className="mx-auto w-full max-w-[350px]">
        ...
        <div className="rounded-lg border border-zinc-300 bg-white p-6 shadow-sm sm:p-7">
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-md border border-zinc-400 bg-white py-3 text-sm font-semibold text-zinc-900 transition hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {googleLoading ? (
            ...
            <div>
              <div className="mb-2 flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  disabled={loading}
                  className="text-xs font-medium text-blue-700 hover:text-amber-700 hover:underline disabled:opacity-50"
                >
                  Forgot password?
                </button>
